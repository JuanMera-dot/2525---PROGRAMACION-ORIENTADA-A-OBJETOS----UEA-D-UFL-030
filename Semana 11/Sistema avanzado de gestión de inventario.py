...
class Dispositivos:
    ...
    #Inicializamos el constructor con la clase y sus atributos

    def __init__(self, id_producto, marca, cantidad, precio, color):
    ...
    def __str__(self):
        return f"{self.id_producto} - {self.marca}, Cantidad: {self.cantidad}, Precio: {self.precio}, Color: {self.color}"

    def linea(self):
        return f"{self.id_producto}, {self.marca}, {self.cantidad}, {self.precio}, {self.color}"
...
class Inventario:
    ...
    def __init__(self):
        self.dispositivos = {}  # Diccionario: clave = id_producto
        ...
        try:
            with open(self.archivo, "r") as f:
                for linea_redaccion in f:
                    ...
                    if dispositivo:
                        self.dispositivos[dispositivo.id_producto] = dispositivo
    ...
    def agregar_dispositivo(self, dispositivo):
        if dispositivo.id_producto in self.dispositivos:
    ...
    def eliminar_dispositivo(self, id_producto):
        if id_producto in self.dispositivos:
            del self.dispositivos[id_producto]
            self.guardar_en_archivo()
    ...
    def actualizar_dispositivo(self, id_producto, cantidad=None, precio=None, color=None):
        if id_producto in self.dispositivos:
            dispositivo = self.dispositivos[id_producto]
...
def menu():
    ...
    while True:
        ...
        if opcion == 1:
            id_producto = input("Ingrese el codigo del dispositivo: ")
            ...
            dispositivo = Dispositivos(id_producto, marca, cantidad, precio, color)
        ...
        # Si se escoge la opcion dos permite eliminar el dispositivo siempre y cuando tenga el codigo
            ...
            id_producto = input("Ingrese el codigo de dispositivo a eliminar: ")
            inventario.eliminar_dispositivo(id_producto)

        # Con la opcion tres definimos nuevas opciones que permitan cambiar o actualizar el producto

        elif opcion == 3:
            id_producto = input("Ingrese el codigo de dispositivo a actulizar: ")
            try:
            ...
            inventario.actualizar_dispositivo(id_producto, cantidad, precio, color)
